...
let sourceSquare = null; // Used for click-to-move piece tracking
...
function askEngine(engine, commands) {
    return new Promise((resolve) => {
        ...
        // Safety fallback timeout to prevent hanging if the engine gets stuck 
...
$('#board').on('click', '.square-55d63', function() {
    ...
    if (sourceSquare === null) {
        ...
        // If clicking the currently highlighted square, simply deselect
        ...
        // If clicking another piece of the player's color, switch selection seamlessly
        ...
        if (isPromo) {
            ...
            // Loop until input is valid or cancelled
            ...
            if (choice) {
                ...
                // Cancelled prompt, abort move and clear selection
                sourceSquare = null;
                $('.square-55d63').removeClass('highlight-select');
                return;
            }
        ...
        // Execute single animation transaction here
        board.position(game.fen());
...
$('#start-btn').on('click', () => {
    ...
    // Clear any residual selection logic
    sourceSquare = null;
    $('.square-55d63').removeClass('highlight-select');
...
// Initialization
const config = {
    draggable: false, // Changed from true to permanently disable dragging logic 
    position: 'start',
