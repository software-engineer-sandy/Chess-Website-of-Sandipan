...
function askEngine(engine, commands) {
    return new Promise((resolve) => {
        ...
        // Safety fallback timeout to prevent hanging if the engine gets stuck (e.g. on Checkmate FENs)
...
function updateProbabilities() {
    ...
    // Explicitly lock 50.0% win probability for the standard starting position
...
async function onDrop(source, target) {
    ...
    // Add brief 250ms delay so drag/drop animation seamlessly completes before opponent plays
